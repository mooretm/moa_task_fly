...
class CalibrationDialog(tk.Toplevel):
    ...
    def _draw_widgets(self):
        ...
        rad_wgn = ttk.Radiobutton(lfrm_load, text="1 kHz Tone", 
            takefocus=0, variable=self.cal_var, value='wgn', 
        ...
        self.lbl_calfile1 = ttk.Label(lfrm_load, text='File:', 
                                      state='disabled')
        self.lbl_calfile1.grid(column=5, row=5, sticky='w', 
                               **options_small)
        self.lbl_calfile2 = ttk.Label(lfrm_load, 
            textvariable=self.cal_path, borderwidth=2, 
            relief="solid", width=60, state='disabled')
        self.lbl_calfile2.grid(column=10, row=5, sticky='w', 
                               **options_small)
        ...
        if self.sessionpars['cal_file'].get() == 'cal_stim.wav':
            ...
            short_path = functions.truncate_path(
        ...
        btn_stop.grid(column=5, row=15, columnspan=6, 
                      sticky='ew', **options_small)
        ...
        ttk.Label(lfrm_slm, text="Magnetic Field Strength (dB SPL):").grid(
        ...
        self.btn_submit.grid(column=5, columnspan=10, row=20, 
            sticky='w', **options_small)
    ...
    def _on_play(self):
        ...
        # Keep measured SLM value disabled
        # Force to 82 dB SPL
